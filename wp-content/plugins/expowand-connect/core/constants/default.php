...
function add_stylesheet_to_head() {
	echo "<style type='text/css'>
			.ew-bg-primary {background:".EW_PRIMARY_COLOR." !important;}
			.ew-bg-secondary {background:".EW_SECONDARY_COLOR." !important;}	
			.ew-color-primary {color:".EW_PRIMARY_COLOR." !important;}
			.ew-color-secondary {color:".EW_SECONDARY_COLOR." !important;}
			.ew-border-color-primary {border-color:".EW_PRIMARY_COLOR." !important;}
		</style>";
}
...
*    GDPR
*********************/
(!empty(get_option('ew-imprint-url')))? define('EW_IMPRINT_URL', get_option('ew-imprint-url') ) : define('EW_IMPRINT_URL', '' ) ;
(!empty(get_option('ew-privacy-url')))? define('EW_PRIVACY_URL', get_option('ew-privacy-url') ) : define('EW_PRIVACY_URL', '' ) ;
