<?php 
	...
	*********************/
	...
	// estateView setting
	(!empty(get_option('ff-estateView-template')))? define('FF_ESTATEVIEW_THEME', get_option('ff-estateView-template') ) : define('FF_ESTATEVIEW_THEME', 'default' ) ;
	...
	define('FF_ESTATEVIEW_SEO_SITEMAP', get_home_url().'/'.FF_PLUGIN_ROUTE.'/'.FF_ESTATEVIEW_ROUTE );
