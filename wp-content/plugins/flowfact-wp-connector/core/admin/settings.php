<?php 
	...
	add_action('admin_menu', function() {
		add_menu_page( 'FLOWFACT SA connector settings', 'FLOWFACT', 'manage_options', 'ff-plugin', 'plugin_page'  );
		
		if ( empty ( $GLOBALS['admin_page_hooks']['ff-plugin'] ) ) 
		{
			add_menu_page( 'FLOWFACT SA connector settings', 'Einstellungen', 'manage_options', 'ff-plugin', 'plugin_page'  );
		}
