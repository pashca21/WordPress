		...
		"basic": {
			...
			"fields": {
				"activition": {
					"point":"1",
					"title":"Aktivierung",
					"description":"Mit dem FLOWFACT Wordpress Connector haben Sie die Möglichkeit, Ihr Wordpress mit Ihrem FLOWFACT zu verbinden. <br /><br />Vom Service ausgenommen, bei Bedarf an Ihren Webdesigner wenden: <br />Änderungen an Layout und Design sowie Beeinträchtigungen durch andere Plugins, beziehungsweise Inkompatibilität und Beeinträchtigungen Ihrer Wordpressumgebung.<br />",
					"fields":{
						"ff-token": {
							"type":"password",
				...
				"valuationMaster": {
					...
					"fields":{
						"ff-valuationMaster-reply-address": {
							"title":"An welche E-Mailadresse sollen die Leads gesendet werden?",
							"type":"text",
							"description":"Entnehmen Sie hier den Status, ob das Produkt erworben und von FLOWFACT für Ihren Vertrag aktiviert wurde. ",
							"requiert":"requiert",
							"default":"'.get_option('ff-nylas-account').'"
						},
